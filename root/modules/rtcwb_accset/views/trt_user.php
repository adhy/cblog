            ...
            <div class="row trcen">
                ...
                <?php foreach ($profile->result() as $row){ ?>
                    <div class="card hovercard">
                        ...
                        <div class="card-info"> <span class="card-title"><?=ucwords($row->nm_user)?></span>
                    ...
                    <div class="btn-pref btn-group btn-group-justified btn-group-lg" role="group" aria-label="...">
                        ...
                        <div class="btn-group" role="group">
                            <button type="button" id="favorites" class="btn btn-default" href="#tab2" data-toggle="tab"><span class="fa fa-lock" aria-hidden="true"></span>
                                <div class="hidden-xs">Social Media</div>
                            </button>
                        </div>
                        <div class="btn-group" role="group">
                            <button type="button" id="following" class="btn btn-default btn-prof" href="#tab3" data-toggle="tab"><span class="fa fa-share-alt" aria-hidden="true"></span>
                                <div class="hidden-xs">Password</div>
                            </button>
                        </div>
                    </div>

                        <div class="col-lg-12 well btn-prof">
