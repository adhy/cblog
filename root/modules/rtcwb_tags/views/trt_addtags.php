      ...
      <div class="modal-body">
            ...
            <div class="form-group hide" id="optionTemplate">
                <div class="col-xs-offset-3 col-xs-5">
                    <input class="form-control ipt-prof" type="hidden" name="tag" autofocus="" disabled="disabled"/>
                </div>
                <div class="col-xs-4">
            ...
            validators: {
                ...
                callback: {
                            callback: function(value, validator, $field) {
                                var $category          = validator.getFieldElements('tags[]'),
                                ...
                                if (duplicateRemoved.length === 0) {
                                    return {
                                        valid: false,
                                        message: 'You must fill at least one tag'
                                    };
                                ...
                                validator.updateStatus('tags[]', validator.STATUS_VALID, 'callback');
                                return true;
                            }
                        },
				remote: {
