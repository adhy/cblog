...
class Zero_hero {
    ...
    public function template_admin($view=null,$data=null){
        $zeroview =& get_instance();
        $zeroview->load->view('pln_template/template/template_top',$data);
        $zeroview->load->view('pln_template/template/template_navigation',$data);
        $zeroview->load->view($view,$data);
        $zeroview->load->view('pln_template/template/template_footer',$data);
        $zeroview->load->view('pln_template/template/template_bottom',$data);
