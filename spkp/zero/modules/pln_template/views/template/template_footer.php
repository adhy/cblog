                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control fc" id="punama" name="punama" placeholder="Username"  type="text" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Nama</label>
                                <div class="col-sm-6">
                                    <input class="form-control fc" id="pnama" name="pnama" placeholder="Nama"  type="text" >
                                </div>
                            </div>
                            <div class="form-group">
