<?php   $attributes = array('class' => 'form-horizontal', 'id' => 'formnilaiedit');
...
<ul class="nav nav-tabs">
 ...
 <?php foreach($tampilalnilai->result() as $row){ ?>
...
<script>
    ...
    $('#formnilaiedit')
            ...
            .find('[name="kkbag3"]').chosen({width: '100%'}).change(function(e){$('#formnilaiedit').formValidation('revalidateField', 'kkbag3');}).end()
            .find('[name="kkbag4"]').chosen({width: '100%'}).change(function(e){$('#formnilaiedit').formValidation('revalidateField', 'kkbag4');}).end()
            .find('[name="kkbag5"]').chosen({width: '100%'}).change(function(e){$('#formnilaiedit').formValidation('revalidateField', 'kkbag5');}).end()
            .find('[name="kkbag6"]').chosen({width: '100%'}).change(function(e){$('#formnilaiedit').formValidation('revalidateField', 'kkbag6');}).end()
            .find('[name="kkbag7"]').chosen({width: '100%'}).change(function(e){$('#formnilaiedit').formValidation('revalidateField', 'kkbag7');}).end()
            .find('[name="kkbag8"]').chosen({width: '100%'}).change(function(e){$('#formnilaiedit').formValidation('revalidateField', 'kkbag8');}).end()
            .find('[name="kkbag11"]').chosen({width: '100%'}).change(function(e){$('#formnilaiedit').formValidation('revalidateField', 'kkbag11');}).end()
            .find('[name="kkbag12"]').chosen({width: '100%'}).change(function(e){$('#formnilaiedit').formValidation('revalidateField', 'kkbag12');}).end()
            .find('[name="kkbag13"]').chosen({width: '100%'}).change(function(e){$('#formnilaiedit').formValidation('revalidateField', 'kkbag13');}).end()
            .find('[name="kkbag14"]').chosen({width: '100%'}).change(function(e){$('#formnilaiedit').formValidation('revalidateField', 'kkbag14');}).end()
            .find('[name="kkbag15"]').chosen({width: '100%'}).change(function(e){$('#formnilaiedit').formValidation('revalidateField', 'kkbag15');}).end()
            .find('[name="kkbag16"]').chosen({width: '100%'}).change(function(e){$('#formnilaiedit').formValidation('revalidateField', 'kkbag16');}).end()
            .find('[name="kkbag17"]').chosen({width: '100%'}).change(function(e){$('#formnilaiedit').formValidation('revalidateField', 'kkbag17');}).end()
            .find('[name="kkbag18"]').chosen({width: '100%'}).change(function(e){$('#formnilaiedit').formValidation('revalidateField', 'kkbag18');}).end()
            .find('[name="kkbag21"]').chosen({width: '100%'}).change(function(e){$('#formnilaiedit').formValidation('revalidateField', 'kkbag21');}).end()
            .find('[name="kkbag22"]').chosen({width: '100%'}).change(function(e){$('#formnilaiedit').formValidation('revalidateField', 'kkbag22');}).end()
            .find('[name="kkbag1"]').chosen({width: '100%'}).change(function(e){$('#formnilaiedit').formValidation('revalidateField', 'kkbag1');}).end()
            .find('[name="kkbag2"]').chosen({width: '100%'}).change(function(e){$('#formnilaiedit').formValidation('revalidateField', 'kkbag2');}).end()
            .formValidation({
        framework: 'bootstrap',
        excluded: ':disabled',
        icon: {
    ...
    .on('success.form.fv', function(e) {
        ...
        $.ajax({
            type    : "POST",
            url     : 'siswa/nilai-edit',
            data    : $('#formnilaiedit').serialize(),
            dataType: 'json',
            success : function(response){
               if(response.msg == 'success'){
                    $('#editnilaisiswa').modal('hide');
                    reload_table();
                    toastr.success('Perubahan data berhasil !'+response.msg);
                }else{
                    $('#editnilaisiswa').modal('hide');
                    reload_table();
                    toastr.error('Perubahan data belum berhasil !'+response.msg);
