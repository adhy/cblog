...
var $skey     = "^%)#(@$~+}|{'})?<9PBSJAR$#&XAE33"; // you can change it
    ...
    public function r_str_replace($code,$newcode,$data){
		$result=str_replace($code,$newcode,$data);
		return $result;
	}
	public function rsumstr_word_count($code){
		$result=str_word_count($code);
		return $result;
	}
	public function r_implode($code,$code2,$code3,$code4){
		$result=implode($code, array_slice(explode($code,$code2),$code3,$code4));
		return $result;
	}
	//$code='';
	//$code2=$data;
	...
	public function notifcom($read){
		$notif_com = '';
		if( $read >0 ) $notif_com = '<i style="color: rgb(255, 0, 0);" class="fa fa-bell fa-fw"></i>';
		//if( $notif_com == '') $notif_com = $read;
		return $notif_com;
	}    
	...
	public $country_code_to_country=array(
		'AF'=>'Afghanistan',
		'AX'=>'Aland Islands',
		'AL'=>'Albania',
		'DZ'=>'Algeria',
    ...
    public function country_codephone_to_country($code){
		$country = '';
		if( $code == 'AF' ) $country = 'Afghanistan';
		if( $code == 'AX' ) $country = 'Aland Islands';
		if( $code == 'AL' ) $country = 'Albania';
	...
	public $country_codephone_to_country=array(
		'AF'=>'Afghanistan',
		'AX'=>'Aland Islands',
		'AL'=>'Albania',
		'DZ'=>'Algeria',
	...
	public function agama_code($code){
		$agama = '';
		if( $code == '0' ) $agama = 'Other';
		if( $code == '1' ) $agama = 'Islam';
		if( $code == '2' ) $agama = 'Kristen';
		if( $code == '3' ) $agama = 'Budha';
		if( $code == '4' ) $agama = 'Hindu';
		if( $code == '5' ) $agama = 'Konghucu';
		if( $agama == '') $agama = $code;
		return $agama;
    }
	
	public $agama_code=array(
		'0' => 'Islam',
		'1' => 'Kristen',
		'2'	=> 'Budha',
		'3'	=> 'Hindu',
	...
	public function kawin_code($code){
		$agama = '';
		if( $code == '0' ) $agama = 'Lajang';
		if( $code == '1' ) $agama = 'Kawin';
		if( $code == '2' ) $agama = 'Janda';
		if( $code == '3' ) $agama = 'Cerai Mati';
		if( $code == '4' ) $agama = 'Cerai Hidup';
		if( $code == '5' ) $agama = 'Cerai';
		if( $agama == '') $agama = $code;
		return $agama;
    }
	
	public function pekerjaan_code($code){
		$agama = '';
		if( $code == '0' ) $agama = 'PNS';
		if( $code == '1' ) $agama = 'TNI';
		if( $code == '2' ) $agama = 'Swasta';
		if( $code == '3' ) $agama = 'Other';
		if( $agama == '') $agama = $code;
		return $agama;
    }
	
	public $pekerjaan_code=array(
		'0'=> 'PNS',
		'1'=> 'TNI',
		'2'=> 'Swasta',
		'3'=> 'Other'
	...
	public function gender_code($code){
		$agama = '';
		if( $code == '0' ) $agama = 'Female';
		if( $code == '1' ) $agama = 'Male';
		if( $code == '2' ) $agama = 'Other';
		if( $agama == '') $agama = $code;
		return $agama;
    }
