...
class Mweb_search extends CI_Model {
	function __constuct()
	{
	...
	public function getcontent_limit($data){
		...
		$this->db->like('tb_content.isi',$data['name_search']);
		$this->db->or_like('tb_content.judul',$data['name_search']);	
	...
	public function sum_content($data){
