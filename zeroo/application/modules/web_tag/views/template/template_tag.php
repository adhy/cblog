    ...
    <div class="container" style="min-height: 525px;">
        ...
        <div class="row">
            ...
            <div class="well sea visible-sm visible-xs">
        			...
        			if($view_catcont=='null_o') {
						echo'<p><i class="fa fa-warning"></i> Tag Not Found</p> <br/>';
					}else{ 					
					...
					</a> | <i class="fa fa-tag"></i> Tag <a href="#<?php echo $row->name_tag ?>" style="text-transform: capitalize;"> <?php echo $row->name_tag ?> </a> | <i class="fa fa-calendar"></i> <?php echo $date_post;?></p><hr>
