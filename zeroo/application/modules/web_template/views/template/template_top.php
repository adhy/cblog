...
<head>
    ...
    <link href="<?php echo base_url('asset/public/css/formValidation.css');?>" rel="stylesheet">
		...
		if(xhr.readyState==0||xhr.readyState==4){
			...
			function myFunction(response) {
				...
				for(b=0;b<tingkat1.length;b++){
					out +='<li><a href="<?php echo site_url("category/'+tingkat1[b].colomleft['nomer']+'");?>">';				
				...
				for(b=0;b<tingkat3.length;b++){
					out +='<li><a href="<?php echo site_url("tag/'+tingkat3[b].tag['link']+'");?>" class="btn btn-primary btn-xs">';				
				...
				for(b=0;b<tingkat4.length;b++){
					...
					out +='<a href="<?php echo site_url("page/'+tingkat4[b].top_post['link']+'");?>">';								
