                               ...
                               <div class="row">
											...
											<div class="col-md-10">
												<section>
														<?php 
														//if($replayc==0){
															$attributes = array('id' => 'replaynow','class'=>'form-horizontal');
															echo form_open_multipart('zero/view-comment/read-comment/', $attributes);
															echo"<fieldset>";
														...
														<div class="form-group">
															...
															<div class="form-group">
																<div class="col-sm-3 col-sm-offset-3">
																	<button type="submit" class="btn btn-primary" name="replaynow" value="Submit">Submit</button>
																</div>
															</div>
