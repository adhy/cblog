    ...
    toolbar: "insertfile undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | fontselect fontsizeselect",
        setup: function(editor) {
            editor.on('keyup', function(e) {
                ...
                $('#editcontent').formValidation('revalidateField', 'tcontent');
            });
        }
    });
	$('#datePicker')
        ...
        .on('changeDate', function(e) {
            ...
            $('#editcontent').formValidation('revalidateField', 'datepost');
        });
    $('#editcontent')			
			.find('[data-rel="chosen"]').chosen()
            // Revalidate the color when it is changed
            .change(function(e) {
                $('#editcontent').formValidation('revalidateField', 'categories');
                $('#editcontent').formValidation('revalidateField', 'tagcont');
            })
            .end()
		.formValidation({
		framework: 'bootstrap',
